 ...
 * 
 */
public class regenerate01_Action extends ScheduleAction {
	...
	public void action(ExecutedTask arg0) {
		...
		//reportUser.generateReportAll(".*RegenMark=[1234,&&[^;]]*1[,$;]*.*", dateString);
		reportUser.generateReportAll("Regenerate_1", dateString);
