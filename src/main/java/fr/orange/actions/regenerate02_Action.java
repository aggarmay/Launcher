 ...
 * 
 */
public class regenerate02_Action extends ScheduleAction {
	...
	public void action(ExecutedTask arg0) {
		...
		//reportUser.generateReportAll(".*RegenMark=[1234,&&[^;]]*2[,$;]*.*", dateString);
		reportUser.generateReportAll("Regenerate_2", dateString);
