 ...
 * 
 */
public class regenerate03_Action extends ScheduleAction {
	...
	public void action(ExecutedTask arg0) {
		...
		//reportUser.generateReportAll(".*RegenMark=[1234,&&[^;]]*3[,$;]*.*", dateString);
		reportUser.generateReportAll("Regenerate_3", dateString);
